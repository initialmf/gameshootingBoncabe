...
AssetsManager.prototype.loadAll = function() {
    ...
    this.images["laserBlue1"].src = "assets/PNG/Lasers/laser.png";
    this.images["laserBlue2"] = new Image();
    this.images["laserBlue2"].src = "assets/PNG/Lasers/laser.png";
    this.images["laserGreen1"] = new Image();
    this.images["laserGreen1"].src = "assets/PNG/Lasers/laserGreen12.png";
    ...
    this.images["laserRed1"].src = "assets/PNG/Lasers/laserGreen12.png";
    this.images["laserRed2"] = new Image();
    this.images["laserRed2"].src = "assets/PNG/Lasers/laserGreen12.png";
    ...
    this.images["laserBlueExplosion1"].src = "assets/PNG/Lasers/laser.png";
    this.images["laserBlueExplosion2"] = new Image();
    this.images["laserBlueExplosion2"].src = "assets/PNG/Lasers/laser.png";

    this.images["laserGreenExplosion1"] = new Image();
    this.images["laserGreenExplosion1"].src = "assets/PNG/Lasers/laser.png";
    this.images["laserGreenExplosion2"] = new Image();
    this.images["laserGreenExplosion2"].src = "assets/PNG/Lasers/laser.png";

    this.images["laserRedExplosion1"] = new Image();
    this.images["laserRedExplosion1"].src = "assets/PNG/Lasers/laser.png";
    this.images["laserRedExplosion2"] = new Image();
    this.images["laserRedExplosion2"].src = "assets/PNG/Lasers/laser.png";

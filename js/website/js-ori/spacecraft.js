...
Spacecraft.prototype.slowDown = function() {
    ...
    if (this.xVelocity > 0 && window.value != "kanan") {
        this.xVelocity -= this.accelerateFactor;
        // setTimeout(function(){ window.value=""; }, 200);
    }

    if (this.xVelocity < 0 && !this.inputManager.keys[37]) {
        this.xVelocity += this.accelerateFactor;
    }
    if (this.xVelocity < 0 && window.value != "kiri") {
        this.xVelocity += this.accelerateFactor;
        // setTimeout(function(){ window.value=""; }, 200);
    }
    // window.value=""; 
...
Spacecraft.prototype.updateDirection = function() {
    ...
    if (window.value == "kanan" && this.xVelocity === 0 && !this.isRightWall) {
        this.xVelocity += this.accelerateFactor;
        this.isLeftWall = false;
        // setTimeout(function(){ window.value=""; }, 200);
    }
    ...
    if (window.value == "kanan" && (Math.abs(this.xVelocity) <= this.maxVelocity)) {
        this.xVelocity += this.accelerateFactor;
        // setTimeout(function(){ window.value=""; }, 200);
    }
    ...
    if (window.value == "kiri" && this.xVelocity === 0 && !this.isLeftWall) {
        this.xVelocity -= this.accelerateFactor;
        this.isRightWall = false;
        // setTimeout(function(){ window.value=""; }, 200);
    }
    ...
    if (window.value == "kiri" && (Math.abs(this.xVelocity) <= this.maxVelocity)) {
        this.xVelocity -= this.accelerateFactor;
        // setTimeout(function(){ window.value=""; }, 200);
    }
